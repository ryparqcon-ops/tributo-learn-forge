// Script de migración directa - copiar y pegar en consola
...
(function() {
  ...
  // Intentar encontrar Supabase en diferentes ubicaciones
  if (window.supabase) {
    ...
    if (reactRoot && reactRoot._reactInternalFiber) {
      ...
      console.log('🔍 Buscando Supabase en React...');
    }
  }
  
  if (!supabase) {
    console.error('❌ No se pudo encontrar el cliente de Supabase');
    console.log('💡 Alternativa: Usar el botón de migración en la página');
    console.log('💡 O ejecutar desde la página /test-supabase');
    return;
  }
