...
const FeaturedInstructors = () => {
  const { instructors: featuredInstructors, loading, error } = useFeaturedInstructors();
        ...
        <div className="max-w-6xl mx-auto">
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-semibold mb-2">Error al cargar los instructores</h3>
                ...
                >
                  <Card className="h-full hover:shadow-lg transition-all duration-300 group">
                    <CardHeader className="text-center pb-4">
                      ...
                      <CardTitle className="text-xl mb-2">{instructor.full_name}</CardTitle>
